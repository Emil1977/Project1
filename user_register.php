...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>Registrieren</h3>
      <input type="text" name="name" required placeholder="Benutzername" maxlength="20"  class="box">
      ...
      <input type="password" name="cpass" required placeholder="Passwort wiederholen" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="submit" value="Registrieren" class="btn" name="submit">
      <p>Du bist schon Registriert?</p>
      <a href="user_login.php" class="option-btn">Einlogen</a>
   </form>
